...
static GLOBAL_COLLECTOR: Mutex<Option<GlobalCollector>> = const_mutex(None);
static SPSC_RXS: Mutex<Vec<Receiver<CollectCommand>>> = const_mutex(Vec::new());
